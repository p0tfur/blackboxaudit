  ...
  <footer class="bg-white border-t border-slate-200 mt-auto">
    <div class="container mx-auto px-4 py-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center gap-2 mb-4">
            ...
            <span class="text-xl font-display font-bold text-slate-900"
              >BlackBoxAudit<span class="text-brand-600">.com</span></span
            >
          </div>
          <p class="text-slate-500 text-sm leading-relaxed max-w-sm">
            Professional automated security auditing tool for modern web applications. Identify vulnerabilities,
            misconfigurations, and security headers in seconds.
          </p>
        </div>

        <div>
          <h5 class="font-bold text-slate-900 mb-4">Resources</h5>
          <ul class="space-y-2 text-sm">
            <li>
              <NuxtLink to="/tips" class="text-slate-600 hover:text-brand-600 transition-colors"
      ...
      <div class="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-slate-400 text-xs">© {{ new Date().getFullYear() }} BlackBoxAudit.com. All rights reserved.</p>
